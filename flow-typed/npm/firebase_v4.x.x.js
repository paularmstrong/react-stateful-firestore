...
declare class $npm$firebase$auth$Auth {
  ...
  signInWithCredential(credential: $npm$firebase$auth$AuthCredential): Promise<$npm$firebase$auth$User>;
...
declare class $npm$firebase$auth$PhoneAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  verifyPhoneNumber(phoneNumber: string, applicationVerifier: $npm$firebase$auth$ApplicationVerifier): Promise<string>;
}
...
declare class $npm$firebase$database$OnDisconnect {
  ...
  set(value: $npm$firebase$database$Value, onComplete?: $npm$firebase$database$OnCompleteCallback): Promise<void>;
  setWithPriority(
...
declare type $npm$firebase$database$Callback = ($npm$firebase$database$DataSnapshot, ?string) => void;
...
declare class $npm$firebase$database$Reference extends $npm$firebase$database$Query {
  ...
  transaction(
    ...
    onComplete?: (error: null | Object, committed: boolean, snapshot: $npm$firebase$database$DataSnapshot) => void,
...
declare class $npm$firebase$firestore$Query {
  ...
  orderBy(
    fieldPath: typeof $npm$firebase$firestore$FieldPath | string,
...
declare class $npm$firebase$firestore$CollectionReference extends $npm$firebase$firestore$Query {
  (): $npm$firebase$firestore$CollectionReference;
  id: string;
...
declare class $npm$firebase$firestore$FieldPath {
  (...args: any): $npm$firebase$firestore$FieldPath;
...
declare class $npm$firebase$firestore$GeoPoint {
  (latitude: number, longitude: number): $npm$firebase$firestore$GeoPoint;
  latitude: number;
  longitude: number;
}
...
declare interface $npm$firebase$firestore$Transaction {
  ...
  get(documentRef: $npm$firebase$firestore$DocumentReference): Promise<$npm$firebase$firestore$DocumentReference>;
  set(
    documentRef: $npm$firebase$firestore$DocumentReference,
    data: {},
    options?: { merge: boolean }
  ): $npm$firebase$firestore$Transaction;
  update(documentRef: $npm$firebase$firestore$DocumentReference, ...args: any): $npm$firebase$firestore$Transaction;
}
...
declare interface $npm$firebase$firestore$WriteBatch {
  ...
  update(documentRef: $npm$firebase$firestore$DocumentReference, ...args: any): $npm$firebase$firestore$WriteBatch;
}
...
declare type $npm$firebase$storage$TaskState = 'running' | 'paused' | 'success' | 'canceled' | 'error';
...
declare class $npm$firebase$storage$Reference {
  ...
  toString(): string;
  updateMetadata(metadata: $npm$firebase$storage$SettableMetadata): Promise<$npm$firebase$storage$FullMetadata>;
}
...
declare type $npm$firebase$storage$Subscribe = (
  observerOrNext: $npm$firebase$storage$Observer | ((snapshot: $npm$firebase$storage$UploadTaskSnapshot) => void),
  onError?: (error: Error) => void,
  onComplete?: () => void
) => $npm$firebase$storage$Unsubscribe;

declare class $npm$firebase$storage$UploadTask extends Promise<$npm$firebase$storage$UploadTaskSnapshot> {
